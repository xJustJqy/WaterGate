...
class ServerInfoResponsePacket extends WaterGatePacket
{
    ...
    public function encodePayload(): void
    {
        ...
        PacketHelper::writeArray($this, $this->playerList, static function (WaterGatePacket $buf, string $playerName) {
            PacketHelper::writeString($buf, $playerName);
        });

        PacketHelper::writeArray($this, $this->serverList, static function (WaterGatePacket $buf, string $serverName) {
    ...
    public function decodePayload(): void
    {
        ...
        $this->playerList = PacketHelper::readArray($this, static function (WaterGatePacket $buf) {
            return PacketHelper::readString($buf);
        });

        $this->serverList = PacketHelper::readArray($this, static function (WaterGatePacket $buf) {
            return PacketHelper::readString($buf);
        });
    }
    ...
    {
        return WaterGatePackets::SERVER_INFO_RESPONSE_PACKET;
    }
